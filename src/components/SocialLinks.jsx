...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/helwiza-fahry-192a19230/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@helwyza_13",
    icon: Instagram,
    url: "https://www.instagram.com/helwyza_13/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@HelwizaFahry",
    icon: Youtube,
    url: "https://www.youtube.com/@HelwizaFahry",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@helwyza-f",
    icon: Github,
    url: "https://github.com/helwyza-f",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-slate-900/90 to-slate-800/90 rounded-2xl p-6 py-8 backdrop-blur-xl">
