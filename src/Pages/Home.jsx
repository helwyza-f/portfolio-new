...
import projects from "../data/projects"; // Impor data proyek dari file yang di-hardcode
import certificates from "../data/certificates"; // Impor data sertifikat dari file yang di-hardcode
...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/helwyza-f" },
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/helwiza-fahry-192a19230/",
  },
  { icon: Instagram, link: "https://www.instagram.com/helwyza_13/" },
];
...
const Home = () => {
  ...
  return (
    <div
      className="min-h-screen bg-[#030014] overflow-hidden md:px-20"
      id="Home"
    >
      <div
